...
import com.fska.frogger.screens.GameScreen;
import com.fska.frogger.sprites.Animation;
import com.fska.frogger.sprites.MovingSprite;
import com.fska.frogger.sprites.Animation.AnimationEvent;
...
public class Player extends MovingSprite implements Animation.AnimationEventListener{
	...
	public void kill () {
		tierSpeed = 0;
		_game.gameData.gameMode = GameState.ANIMATE;
		active = false; 
		dead = true;
